...
<html>
<head>
<title>CYBER SHOPPY :: MEN'S</title>
<!--/tags -->
...
<div class="header" id="home">
	<div class="container">
		<ul>
		    <li> <a href="LOGIN1.php" data-toggle="modal" data-target="#myModal"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </a></li>
			<li> <a href="REGISTER1.php" data-toggle="modal" data-target="#myModal2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
...
$esql="select * from product where men=1 and cat_id='cid'";
$eerec=mysqli_query($db,$esql);
echo $eerec;
exit;
$eres = mysqli_fetch_assoc($eerec);
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
								...
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.php" cid="1">Clothing</a></li>
											<li><a href="mens.php" cid="2">Wallets</a></li>
											<li><a href="mens.php" cid="3">Footwear</a></li>
											<li><a href="mens.php" cid="4">Watches</a></li>
											<li><a href="mens.php" cid="5">Accessories</a></li>
											<li><a href="mens.php" cid="6">Bags</a></li>
											<li><a href="mens.php" cid="7">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
					...
					<li class="dropdown menu__item">
						<a href="womens.php" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Women's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
				...
				<h3>Filter By <span>Price</span></h3>
					<ul class="dropdown-menu6">
						<li>                
							...
							<input name="amount" type="text" id="amount" style="border: 0; color: #ffffff; font-weight: normal;" />
						</li>			
					</ul>
			</div>
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">\
										...
										<img src="<?php echo $fres['url'];?>" alt="" class="pro-image-front">
										<img src="<?php echo $fres['url'];?>" alt="" class="pro-image-back">
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		...
		<p class="copy-right">&copy 2018 CYBER Shoppy. All rights reserved | Design by <a href="http://w3layouts.com/">CYBERS</a></p>
	</div>
</div>
<!-- //footer -->
