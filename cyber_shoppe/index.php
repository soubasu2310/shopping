	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			...
			if(isset($_SESSION['first_name'])){ 
					?>
			<table><tr><td><b>Welcome,<?php  echo $_SESSION['first_name']; ?></b></td></tr>
			<?php }?>
			</table>
         <!-- header-bot -->
...
<!--/grids-->
      <div class="agile_last_double_sectionw3ls">
            <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="#"><img src="images/bot_1.jpg" alt=" " border="0">
			  <h4>Flat <span>50%</span> offer</h4></a>
					
		</div>
			 <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="#"><img src="images/bot_2.jpg" alt=" " border="0">
			   <h4>Flat <span>50%</span> offer</h4></a>
		</div>
			<div class="clearfix"></div>
</div>							
...
<!-- /new_arrivals --> 
	...
	<!-- /we-offer -->
		<div class="sale-w3ls">
			<div class="container">
				<h6>We Offer Flat <span><font color="#A8A8A8">50%/></span> Discount</h6>
