...
$p="SELECT b.*, c.* from billing b,product c where b.p_id=c.p_id and b.user_id='$log_id'";
...
&nbsp;
		<div class="clearfix"></div>
<div  align="left" class="col-md-3 product-men">
								<div>
...
?>
	  ...
	  <table width="728" align="center">
          ...
          <td width="119">&nbsp;</td>
          <td width="83">&nbsp;</td>
          <td width="113"><strong><?php echo $total;?>/- Only</strong></td>
        </tr>
		<tr>
          <td width="192">&nbsp;</td>
          <td width="120">&nbsp;</td>
