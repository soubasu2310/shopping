	...
	<div class="container">
		<ul>
		    <li><i class="fa fa-unlock-alt" ></i> Signed In as <?php echo $_SESSION['first_name']; ?>  </li>
			 ...
			 <li><i class="fa fa-unlock-alt" ></i>  <?php echo date("d/m/Y");?>
			  <li><i class="fa fa-time-alt" ></i>  <?php echo date("h:i a"); ?>
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item">
						...
						<?php
	           $result1 = mysqli_query($conn, "SELECT * FROM sub_cat where cat_id=1 and is_active=1");
							...
							<ul class="dropdown-menu multi-column columns-3">
								...
								<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
			   <?php
	           $result2 = mysqli_query($conn, "SELECT * FROM sub_cat where cat_id=2 and is_active=1");
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Your Item is Ready in the <span>Cart </span></h3>
			<!--/w3_short-->
...
&nbsp;
		<div class="clearfix"></div>
<div  align="center" class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
								<img src="images/Prod_image/cart1.jpg" />
						</div>
				</div>
<div  align="center" class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
<form action="" method="post">
  <?php
	  ...
	  $sql1="insert into billing (billing_id,user_id,p_id,qty,value) values('','1','$prid','$enc_quants','$net_total')";
	  //echo $sql1;
	   $ins_cart=mysqli_query($conn,$sql1);
	  ?>
	  
<table width="550" border="0" align="center">

<tr>
<td width="130"><img src="images/Prod_image/cart_icon2.png" width="60px" height="100px"/></td>
<td width="10"></td>
</tr>
  <tr>
    <td height="39"><div align="left"><strong>User Id </strong></div></td>
    <td><div align="center"><strong>:</strong></div></td>
    <td width="396">
      <div align="center"><?php echo $log_id;?></div></td>
  </tr>
  <tr>
    <td height="38"><div align="left"><strong>Product Name </strong></div></td>
    <td align="center"><strong>:</strong></td>
    <td align="center"><?php echo $_POST["item_name"]; ?>      </td>
  </tr>
  <tr>
    <td height="37"><div align="left"><strong>Quantity</strong></div></td>
    <td><div align="center"><strong>:</strong></div></td>
    <td align="center">
      <div align="center"><?php echo $_POST["quants"]; ?></div></td>
  </tr>
  <tr>
    <td height="36"><div align="left"><strong>Price</strong></div></td>
    <td><div align="center"><strong>:</strong></div></td>
    <td align="center">
      <div align="center"><?php echo $_POST["amount"]; ?></div></td>
  </tr>
  <tr>
    <td height="34"><div align="left"><strong>Discount</strong></div></td>
    <td><div align="center"><strong>:</strong></div></td>
    <td align="center"><?php echo $_POST["discount_amount"]; ?></td>
  </tr>
  <tr>
    <td height="35"><div align="left"><strong>Value</strong></div></td>
    <td><div align="center"><strong>:</strong></div></td>
...
<div  align="center" class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
							<table><img src="images/Prod_image/cart4.jpg"/></table>	
						</div>
				</div>
