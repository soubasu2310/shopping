...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">INR 650</span> <del>- INR 950</del></p>
					<div class="rating1">
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="discount_amount" value="300">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price">INR 799</span>
											<del>INR 899</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
                       ...
                       <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price">INR 599</span>
											<del>INR 899</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
						 ...
						 <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price">INR 600 </span>
											<del>INR 1000</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="discount_amount" value="400">
																	<input type="hidden" name="currency_code" value="INR ">
																	<input type="hidden" name="return" value=" ">
																	<input type="hidden" name="cancel_return" value=" ">
																	<input type="submit" name="submit" value="Add to cart" class="button">
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price">INR 100</span>
											<del>INR 150</del></div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
