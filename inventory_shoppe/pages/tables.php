				...
				?>
				  ...
				  ?>
                                            <tbody>
                                                <tr class="panel-body">
      <th><?php echo $i;?></th>
	  <th><?php echo $fres['vendor_name'];?></th>
	  <th><?php echo $fres['vendor_email'];?></th>
      <th><?php echo $fres['phone'];?></th>

      <th><button type="button" class="btn btn-outline btn-success"><a href="vendor_request.php?I=<?php  echo $fres['vendor_id']; ?>">Pending</a></button> | <button type="button" class="btn btn-outline btn-success"><a href="vendor_request.php?D=<?php  echo $fres['vendor_id']; ?>">Delete</a></button> </th>
    </tr>
	<?php
				  $i++;
				  }
