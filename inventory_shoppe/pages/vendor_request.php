...
if(isset($_GET['I']))
{
	...
	$esql = "select * from vendor_master where is_active='2'";
	...
	$chart="insert into vendor_chart_master(v_chart_id,year,sales,v_id) values('','2019',0,'$I')";
	//echo $chart;
	//exit;
	$chart_run=mysqli_query($conn,$chart);
...
<html lang="en">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <td><button type="button" class="btn btn-outline btn-success"><a href="vendor_request.php?I=<?php  echo $fres['vendor_id']; ?>">ACCEPT</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="vendor_request.php?D=<?php  echo $fres['vendor_id']; ?>">Delete</a></button> </td>
                                                </tr>
