...
if(isset($_GET['I']))
{
	...
	$esql = "select * from user_master where is_active='2'";
	$erec = mysqli_query($conn,$esql);
	$eres = mysqli_fetch_assoc($erec);
	$eesql="update user_master set is_active=1 where user_id='$I'";
			//echo $eesql;
			//exit;
		  ...
		  echo "<script>
							 ...
							 location.replace('user_request.php?');
							 </script>";
...
{
	$D = $_GET['D'];
	$dsql = "update user_master set is_active=0 where user_id='$D'";
...
{
	$D = $_GET['D'];
	$dsql = "delete from user_master where user_id='$D'";
	$drec = mysqli_query($conn,$dsql);
            ...
            <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3 align="center">::USER REQUESTS::</h3></div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
											...
											<?php
				$fsql = "select * from user_master where is_active='2'";
				...
				?>
				  ...
				  ?>
                                                <tr class="odd gradeX">
                                                                                                <td><?php echo $i;?></td>
	  <td><?php echo $fres['first_name'];?></td>
	  <td><?php echo $fres['last_name'];?></td>
	  <td><?php echo $fres['user_email'];?></td>
      <td><?php echo $fres['phone'];?></td>

      <td><button type="button" class="btn btn-outline btn-warning"><a href="user_request.php?I=<?php  echo $fres['user_id']; ?>">Active</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="user_request.php?D=<?php  echo $fres['user_id']; ?>">Inactive</a></button> </td>
                                                </tr>
