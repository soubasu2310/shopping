...
{
	$D = $_GET['D'];
	$dsql = "update product set is_active='0' where p_id='$D'";
	//echo $dsql;
	//exit;
	...
	if($drec)
	{
		echo "<script>
					...
					location.replace('product_management.php?')
					</script>";
	}
}
...
<html lang="en">
	...
	<form id="form1" name="form1" method="post" action="">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="../vendor_update.php"><i class="fa fa-gear fa-fw"></i> Settings</a>
                            </li>
                            <li class="divider"></li>
      ...
      <td colspan="2">Action</td>
				...
				$fsql = "select * from product where vendor_id='$log_id' and  is_active='1'";
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="44"><button type="button" class="btn btn-outline btn-success"><a href="../update.php?I=<?php echo base64_encode($fres['p_id']);?>">Edit</a></button></td>
      <td width="55"><button type="button" class="btn btn-outline btn-danger"><a href="product_management.php?D=<?php  echo $fres['p_id']; ?>">Delete</a>
        </button></td>
    </tr>
	<?php
				  $i++;
