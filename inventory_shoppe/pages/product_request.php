...
<html lang="en">
	...
	<td><?php echo $i;?></td>
	  ...
	  <td width="149"><button type="button" class="btn btn-outline btn-warning"><a href="product_request.php?I=<?php echo $fres['p_id']; ?>">Accept</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="product_request.php?D=<?php  echo $fres['p_id']; ?>">Delete</a>
        </button></td>
    					</tr>
