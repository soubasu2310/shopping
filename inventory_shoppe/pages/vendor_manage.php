...
<html lang="en">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <td><button type="button" class="btn btn-outline btn-success"><a href="vendor_manage.php?I=<?php  echo $fres['vendor_id']; ?>">Block</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="vendor_manage.php?D=<?php  echo $fres['vendor_id']; ?>">Delete</a></button> </td>
                                                </tr>
